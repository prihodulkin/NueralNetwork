...
namespace NeuralNetwork1
{
    public class FiguresGenerator: IGenerator<FigureSampleData>
    {
        ...
        /// </summary>
        private bool[,] img = new bool[200, 200];
        ...
        /// </summary>
        private FigureType currentFigure = FigureType.Undef;

        /// <summary>
        /// Количество классов генерируемых фигур (4 - максимум)
        /// </summary>
        public int ClassesCount { get; set; } = 4;

        /// <summary>
        /// Диапазон смещения центра фигуры (по умолчанию +/- 20 пикселов от центра)
        /// </summary>
        private int FigureCenterGitter { get; set; } = 50;

        /// <summary>
        /// Диапазон разброса размера фигур
        /// </summary>
        private int FigureSizeGitter { get; set; } = 50;
       ...
       public Sample<FigureSampleData> GenerateFigure()
        ...
        private void get_random_figure()
        {
            ClearImage();
        ...
        private void generate_figure(FigureType type = FigureType.Undef)
        {

            if (type == FigureType.Undef || (int)type >= ClassesCount)
                type = (FigureType)rand.Next(ClassesCount);
            ClearImage();
            switch (type)
            {
